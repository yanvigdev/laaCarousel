...
(function ( $, window, document, undefined ) {
	...
	*/
    ...
    /**
	 * Methode qui verifie le chargment de toutes les images.
	 *
	 */
    ...
    /**
	 * Methode qui ajout des fleches pour passer a l'image suivante ou precèdente
	 */
    ...
    Plugin.prototype.update = function(){
        ...
        {
            iFunc();//lancement de chacune des fonctions contenues dans le tableau update
        });
        if(self.callback){
            self.callback(self);
        }
